...
function problemB () {
 ...
 /*  readFile('poem-one/stanza-02.txt', function (err, stanza2) {
  ...
  // promise version
  var promesa2 = promisifiedReadFile('poem-one/stanza-02.txt');
  promesa2.then(function (stanza2){
    console.log('-- B. callback version (stanza two) --');
    blue(stanza2);
  })
  var promesa3 = promisifiedReadFile('poem-one/stanza-03.txt');
  promesa3.then(function (stanza3){
    console.log('-- B. callback version (stanza three) --');
    blue(stanza3);
  })
